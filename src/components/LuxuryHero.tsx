      ...
      <div className="relative z-10 container mx-auto px-6 text-center">
        ...
        >
          <div className="flex items-center justify-center gap-2 mb-6">
            ...
            <span className="text-xs tracking-[0.4em] uppercase text-gold font-sans font-medium">Escape to the Extraordinary</span>
          </div>
          
          <h1 className="font-serif text-6xl md:text-8xl lg:text-9xl text-white leading-tight mb-8">
            Verdant Luxe <br /> <span className="italic font-light text-gold text-glow">Reserve</span>
          </h1>
          ...
          <div className="flex flex-col sm:flex-row items-center justify-center gap-6">
            <button
              onClick={onBookClick}
              className="px-10 py-4 bg-gold hover:bg-gold-light text-luxury-dark text-sm tracking-[0.2em] uppercase font-bold transition-all duration-300 shadow-xl cursor-pointer"
            >
              Secure Stay
            </button>
            <button
              onClick={onExploreClick}
              className="px-10 py-4 bg-transparent border border-gold/40 hover:border-gold text-gold text-sm tracking-[0.2em] uppercase font-bold transition-all duration-300 hover:bg-gold/5 cursor-pointer"
            >
              View Gallery
            </button>
          </div>
