...
export const amenitiesList: PropertyAmenity[] = [
  {
    ...
    description: "An exclusive heated pool illuminated with custom twilight fiber-optics — completely private for you and your guests. Feel free to contact our coordinator to organize customized modifications like adjusting the temperature of your wellness twilight Jacuzzi or planning authentic Indori brunch dishes dynamically for your staycation.",
    icon: "Waves",
  ...
  },
  {
    ...
    description: "Unwind in bubble jet streams featuring custom chromotherapy lights, romantic set candle glow, and curated thermal control. Our coordinator can arrange for fresh rose petals and specific aromatherapy scents to enhance your wellness journey.",
    icon: "Flame",
  ...
  {
    id: "restaurant",
    name: "In-House Gourmet Dine",
    tagline: "Farm-to-Table Culinary Arts",
    description: "Savour outstanding cuisine curated by our private chef. From authentic Indori morning platters to twilight poolside dining. Customize your menu with Chef Vivek Sharma to include organic ingredients harvested directly from our sanctuary gardens.",
    icon: "Utensils",
  ...
  },
  {
    ...
    description: "Plush designer bedrooms with smart dimming lights, opulent Egyptian cotton bedding, and masterfully crafted garden-view windows. Each suite is a haven of tranquility designed to provide the ultimate restorative sleep experience.",
    icon: "BedDouble",
  ...
  },
  {
    ...
    description: "Poolside layouts of red rose paths, candle grids, and customized balloons perfect for anniversaries and bespoke couple nights. Let our architects design a personalized romantic sequence that begins at the gate and ends with a floating dinner.",
    icon: "Heart",
  ...
  },
  {
    ...
    description: "Host safe family reunions, birthday bashes, and corporate retreats with private lounge bean bags and professional sound systems. Our vast estate provides multiple zones for different group activities, ensuring everyone finds their perfect pocket of joy.",
    icon: "Users",
